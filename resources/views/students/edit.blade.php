    ...
    <div
        ...
        <div class="max-w-4xl mx-auto">
            <div class="mb-8">
                ...
                <p class="text-gray-600 dark:text-gray-300">Update data siswa: {{ $student->nama }}</p>
            </div>
                ...
                <form action="{{ route('students.update', $student) }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="form-group">
                        ...
                        <div class="mb-3">
                            ...
                            <img src="{{ asset('storage/' . $student->foto) }}" alt="Foto Saat Ini"
                                class="w-32 h-32 rounded-xl object-cover border-2 border-gray-200 dark:border-gray-600">
                        </div>
                        @endif
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nama" id="nama" class="form-input"
                                placeholder="Masukkan nama lengkap" value="{{ old('nama', $student->nama) }}">
                            @error('nama')
                            <p class="form-error">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="kelas" id="kelas" class="form-input"
                                placeholder="Contoh: X, XI, XII" value="{{ old('kelas', $student->kelas) }}">
                            @error('kelas')
                            <p class="form-error">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="jurusan" id="jurusan" class="form-select">
                                ...
                                <option value="Pengembangan Perangkat Lunak dan Gim"
                                    {{ old('jurusan', $student->jurusan) == 'Pengembangan Perangkat Lunak dan Gim' ? 'selected' : '' }}>
                                    Pengembangan Perangkat Lunak dan Gim
                                </option>
                                <option value="Teknik Otomotif"
                                    {{ old('jurusan', $student->jurusan) == 'Teknik Otomotif' ? 'selected' : '' }}>
                                    Teknik Otomotif
                                </option>
                                <option value="Teknik Pengelasan dan Fabrikasi Logam"
                                    {{ old('jurusan', $student->jurusan) == 'Teknik Pengelasan dan Fabrikasi Logam' ? 'selected' : '' }}>
                                    Teknik Pengelasan dan Fabrikasi Logam
                                </option>
                                <option value="Broadcasting dan Film"
                                    {{ old('jurusan', $student->jurusan) == 'Broadcasting dan Film' ? 'selected' : '' }}>
                                    Broadcasting dan Film
                                </option>
                                <option value="Animasi"
                                    {{ old('jurusan', $student->jurusan) == 'Animasi' ? 'selected' : '' }}>
                                    Animasi
                                </option>
                            </select>
                            @error('jurusan')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="angkatan" id="angkatan" class="form-input"
                                placeholder="Contoh: 2024" value="{{ old('angkatan', $student->angkatan) }}">
                            @error('angkatan')
                            <p class="form-error">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="is_active" id="is_active" class="form-select">
                            <option value="1" {{ old('is_active', $student->is_active) == 1 ? 'selected' : '' }}>Aktif
                            </option>
                            <option value="0" {{ old('is_active', $student->is_active) == 0 ? 'selected' : '' }}>Tidak
                                Aktif</option>
                        </select>
                        @error('is_active')
                        <p class="form-error">{{ $message }}</p>
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 pt-6 border-t border-gray-200 dark:border-gray-600">
                        ...
                        <a href="{{ route('students.show', $student) }}" class="btn-secondary text-center">
