    ...
    <div
        ...
        <div class="max-w-4xl mx-auto">
            <div class="mb-8">
                ...
                <p class="text-gray-600 dark:text-gray-300">Update data guru: {{ $teacher->nama }}</p>
            </div>
                ...
                <form action="{{ route('teachers.update', $teacher) }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nama" id="nama" class="form-input"
                                placeholder="Masukkan nama lengkap" value="{{ old('nama', $teacher->nama) }}">
                            @error('nama')
                            <p class="form-error">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="jabatan" id="jabatan" class="form-input"
                                placeholder="Masukkan jabatan" value="{{ old('jabatan', $teacher->jabatan) }}">
                            @error('jabatan')
                            <p class="form-error">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="no_hp" id="no_hp" class="form-input"
                                placeholder="Masukkan nomor HP" value="{{ old('no_hp', $teacher->no_hp) }}">
                            @error('no_hp')
                            <p class="form-error">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="is_active" id="is_active" class="form-select">
                            <option value="1" {{ old('is_active', $teacher->is_active) == 1 ? 'selected' : '' }}>Aktif
                            </option>
                            <option value="0" {{ old('is_active', $teacher->is_active) == 0 ? 'selected' : '' }}>Tidak
                                Aktif</option>
                        </select>
                        @error('is_active')
                        <p class="form-error">{{ $message }}</p>
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 pt-6 border-t border-gray-200 dark:border-gray-600">
                        ...
                        <a href="{{ route('teachers.show', $teacher) }}" class="btn-secondary text-center">
