        ...
        <>
            ...
            <div className="max-w-2xl mx-auto">
                <div className="flex items-center gap-4 mb-10">
                    ...
                    <div>
                        <h2 className="text-3xl font-extrabold text-slate-900 tracking-tight">New Teacher</h2>
                        <p className="text-slate-500 font-medium">Register a new staff member to the system.</p>
                    </div>
                </div>
...
Create.layout = page => <AuthenticatedLayout header="Add New Teacher">{page}</AuthenticatedLayout>;
