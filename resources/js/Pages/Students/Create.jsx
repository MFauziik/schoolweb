            ...
            <div className="max-w-2xl mx-auto">
                <div className="flex items-center gap-4 mb-10">
                    ...
                    <div>
                        ...
                        <p className="text-slate-500 font-medium">Fill in the information to register a new student.</p>
                    </div>
                </div>
                ...
                <form onSubmit={submit} className="bg-white rounded-[2.5rem] p-10 border border-slate-100 shadow-sm space-y-8">
                    <div className="space-y-6">
                        ...
                        <div>
                            <InputLabel value="Student Photo" />
                            <input
                                type="file"
...
Create.layout = page => <AuthenticatedLayout header="Add New Student">{page}</AuthenticatedLayout>;
